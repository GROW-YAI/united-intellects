  ...
  return (
    <div className="max-w-6xl mx-auto px-6 sm:px-8 md:px-12 py-12">
      ...
      <div className="mt-10 flex flex-col md:flex-row items-center gap-8">
        <img src="/Our Story.jpg" alt="Background" className="w-full md:w-1/2 rounded-lg shadow-lg" />
      ...
      <div className="mt-10 flex flex-col md:flex-row-reverse items-center gap-8">
        <img src="/Protect Biodiversity 1.jpg" alt="Mission" className="w-full md:w-1/2 rounded-lg shadow-lg" />
        <div className="md:w-1/2">
          <h3 className="text-2xl font-bold text-green-700 flex items-center gap-2">
      ...
      {/* Why It Matters */}
      <div className="mt-10 flex flex-col md:flex-row items-center gap-8">
        <img src="/why it matters pic.jpg" alt="Why It Matters" className="w-full md:w-1/2 rounded-lg shadow-lg" />
        <div className="md:w-1/2">
          <h3 className="text-2xl font-bold text-green-700 flex items-center gap-2">
