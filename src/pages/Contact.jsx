...
const Contact = () => {
  ...
  return (
    <motion.div className="min-h-screen flex flex-col">
      {/* Welcoming Section */}
      <Welcoming 
        title="Connect with us to learn more about our clean energy and conservation initiatives"
        showHeadmaster={false}
      />

      <motion.div className="flex-grow flex items-center justify-center bg-gray-50 p-10">
